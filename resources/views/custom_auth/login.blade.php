            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">{{ __('auth.SignIn') }}</h1>
                        <p class="">{{ __('auth.LogInTitle') }}</p>

                        <form id="login_form" class="text-left" method="POST" action="{{ $url }}">
                            @csrf
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ $forgot_password_url }}" class="forgot-pass-link">{{ __('auth.ForgotPassword?') }}</a>
                                    </div>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-eye show-password">
                                ...
                                @if ($type != "admin")
                                    <p class="signup-link">{{ __('common.NotRegistered?') }} <a href="{{ $urlSignUp }}"> {{ __('common.CreateAnAccount') }}</a></p>
                                @endif
            ...
            $(document).on("click", ".show-password", function() {
                ...
                if (input.attr("type") == "password") {
                    ...
                    input.parent().append(
                        `<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-eye-off show-password">
