            ...
            <tr>
                <td class="content-cell" align="center"
                    ...
                    <p class="f-fallback sub align-center"
                        ...
                        align="center"> © {{ date('Y') }} {{ config('app.name', 'Laravel') }}.
                        Crafted with ❤ by {{ config('app.develop_by_name', 'Dhruv') }}</p>
                    <!-- <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #6B6E76; margin: .4em 0 1.1875em;" align="center"> [Company Name, LLC]
                        <br />1234 Street Rd.
                        <br />Suite 1234
                    </p> -->
                </td>
