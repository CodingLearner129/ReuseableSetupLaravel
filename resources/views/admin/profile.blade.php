<x-app-layout>
                                    ...
                                    <label class="picture" for="picture__input" tabIndex="0">
                                        <span class="picture__image">
                                            <img src="{{ isset($profile_picture) && $profile_picture != '' ? asset('storage/' . $profile_picture) : asset('assets/img/400x300.jpg') }}"
                                                class="picture__img">
                                            {{-- <img src="{{ isset($profile_picture) && $profile_picture != '' ? storage_path('app/public/'.$profile_picture) : asset('assets/img/400x300.jpg') }}"
                                                class="picture__img"> right now doesn't works --}}
                                        </span>
                                    </label>
                            ...
                            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 row">
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" placeholder="{{ __('common.EnterFullName') }}"
    ...
    <x-slot name="script">
        ...
        <script src="{{ asset('assets/js/admin/editProfile.js') }}"></script>
    </x-slot>
</x-app-layout>
