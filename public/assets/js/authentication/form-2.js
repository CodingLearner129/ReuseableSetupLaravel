    ...
    if (togglePassword) {
        togglePassword.addEventListener('click', function () {
            ...
            if (x.type === "password") {
                ...
                x.parentNode.innerHTML += `<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" id="toggle-password" class="feather feather-eye-off">
                ...
                x.type = "password";
                togglePassword.remove();
                x.parentNode.innerHTML += `<svg width="24" height="24"
